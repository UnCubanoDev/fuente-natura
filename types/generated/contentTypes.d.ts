...
export interface ApiOrdenOrden extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    comprador: Schema.Attribute.Component<'orden.datos-comprador', false>;
    cotizacion_24h: Schema.Attribute.Decimal;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::orden.orden'> &
      Schema.Attribute.Private;
    metodo_pago: Schema.Attribute.Enumeration<['efectivo', 'zelle']> &
      Schema.Attribute.Required;
    notas_admin: Schema.Attribute.Text;
    productos: Schema.Attribute.Relation<
      'manyToMany',
      'api::producto.producto'
    >;
    productos_deseados: Schema.Attribute.Component<
      'orden.productos-deseados',
      true
    >;
    publishedAt: Schema.Attribute.DateTime;
    receptor: Schema.Attribute.Component<'orden.datos-receptor', false> &
      Schema.Attribute.Required;
    status_order: Schema.Attribute.Enumeration<
      ['pending', 'quoted', 'confirmed', 'rejected', 'paid', 'shipped']
    >;
